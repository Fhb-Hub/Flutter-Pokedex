class PokemonModel {
  ...
  final int defense;
  final int speed;
  final int specialAtt;
  final int specialDef;
  ...
  const PokemonModel({
    ...
    required this.speed,
    required this.specialAtt,
    required this.specialDef,
  });
  ...
  factory PokemonModel.fromMap(Map<String, dynamic> json) {
    ...
    return PokemonModel(
      ...
      specialAtt: statsList[3]['base_stat'],
      specialDef: statsList[4]['base_stat'],
